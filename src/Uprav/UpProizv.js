...
export default function UpProizv () {
    ...
    return (<upproizv>
      <div >
            ...
            <Link to='/UpZapas'><button className='tabsbutton'>Управление запасами</button></Link>
                          <Link to='/UpProizv'><button className='tabsbuttonON'>Управление производства</button></Link>
                        ...
                        <fieldset className='fieldtd'><legend>Управление производством</legend>
